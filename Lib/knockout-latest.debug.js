...
(function(window, document, navigator, undefined) {
  ...
  ! function(factory) {
    ...
    ko.utils = new(function() {
      ...
      return {
        ...
        getFormFields: function(form, fieldName) {
          var fields = ko.utils.makeArray(form.getElementsByTagName("input"))
            .concat(ko.utils.makeArray(form.getElementsByTagName("textarea")));
    ...
    ko.utils.domData = new(function() {
      var uniqueId = 0;
      var dataStoreKeyExpandoPropertyName = "__ko__" + (new Date)
        .getTime();
      var dataStore = {};
      return {
    ...
    ko.utils.domNodeDisposal = new(function() {
      var domDataKey = "__ko_domNodeDisposal__" + (new Date)
        .getTime();
      ...
      return {
        addDisposeCallback: function(node, callback) {
          ...
          getDisposeCallbacksCollection(node, true)
            .push(callback);
        },
    ...
    (function() {
      ...
      function simpleHtmlParse(html) {
        ...
        var tags = ko.utils.stringTrim(html)
          .toLowerCase(),
          div = document.createElement("div");
    ...
    ko.jsonExpressionRewriting = (function() {
      ...
      function isWriteableValue(expression) {
        if (ko.utils.arrayIndexOf(javaScriptReservedWords, ko.utils.stringTrim(expression)
          .toLowerCase()) >= 0)
          return false;
    ...
    (function() {
      ...
      var commentNodesHaveTextProperty = document.createComment("test")
        .text === "<!--test-->";
      ...
      function isStartComment(node) {
        return (node.nodeType == 8) && (commentNodesHaveTextProperty ? node.text : node.nodeValue)
    ...
    (function() {
      ...
      function applyBindingsToNodeAndDescendantsInternal(viewModel, nodeVerified, bindingContextMayDifferFromDomParentElement) {
        ...
        if (shouldApplyBindings)
          shouldBindDescendants = applyBindingsToNodeInternal(nodeVerified, null, viewModel, bindingContextMayDifferFromDomParentElement)
    ...
    ko.nativeTemplateEngine.prototype['renderTemplateSource'] = function(templateSource, bindingContext, options) {
      ...
      if (templateNodes) {
        return ko.utils.makeArray(templateNodes.cloneNode(true)
          .childNodes);
      } else {
    ...
    (function() {
      ko.jqueryTmplTemplateEngine = function() {
        ...
        var jQueryTmplVersion = this.jQueryTmplVersion = (function() {
          ...
          try {
            if (jQuery['tmpl']['tag']['tmpl']['open'].toString()
              .indexOf('__') >= 0) {
