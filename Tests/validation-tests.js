...
test('Custom Message Correctly appears', function() {
  ...
  var testObj = ko.observable('something')
    .extend({
      required: {
...
test('Error Grouping works', function() {
  ...
  equals(errors()
    .length, 2, 'Grouping correctly finds 2 invalid properties');
});
...
test('Nested Grouping works - Observable', function() {
  ...
  equals(errors()
    .length, 3, 'Grouping correctly finds 3 invalid properties');
});
